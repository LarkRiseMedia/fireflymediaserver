...
char *db_sqlite_updates[] = {
    ...
    ");\n"
    "begin transaction;\n"
    "insert into songs select id,path,fname,title,artist,album,genre,comment,"
    "type,composer,orchestra,conductor,grouping,url,bitrate,samplerate,song_length,"
    "file_size,year,track,total_tracks,disc,total_discs,bpm,compilation,rating,"
    "play_count,data_kind,item_kind,description,time_added,time_modified,time_played,"
